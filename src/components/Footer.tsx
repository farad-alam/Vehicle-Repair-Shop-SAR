  ...
  return (
    <footer className="pt-24 pb-12 bg-background">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 flex flex-col gap-6">
        ...
        <div className="bg-surface rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 border border-white/5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-primary rounded-3xl p-12 flex flex-col items-center justify-center min-h-[300px]">
            <div className="bg-white/10 p-6 rounded-3xl mb-6 backdrop-blur-md">
          ...
          <div className="bg-surface border border-white/5 rounded-3xl p-8 md:p-12 lg:col-span-2 flex flex-col justify-between min-h-[300px]">
            <div>
              <div className="flex items-center gap-2 mb-10 bg-white/5 w-fit px-5 py-2 rounded-full border border-white/10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <a href="#" className="bg-surface border border-white/5 hover:border-primary/50 hover:bg-white/5 transition-all rounded-3xl aspect-square flex items-center justify-center group">
